...
const Footertext = {
  email: "muhammad.yasir1368@gmail.com",
  ...
  copyright: "Copyright © 2026 Muhammad Yasir. All Rights Reserved.",
};
...
const Footersocial = [
  {
    key: "github",
    label: "GitHub",
    link: "https://github.com/myasirweb",
    icon: (
  ...
  },
  {
    key: "linkedin",
    label: "LinkedIn",
    link: "https://www.linkedin.com/in/myasirweb/",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
    ...
    <footer>
      ...
      <div className="ak-footer ak-style-1">
        ...
        <div className="container ak-hr-container" ref={footerContainer}>
          ...
          <div className="copy-right-section d-flex justify-content-between align-items-center flex-wrap gap-3">
