...
const about_content = {
  ...
  subtext:
    "At VELOUR, we strive to create a gastronomic haven that excites the senses and leaves a lasting impression with every visit.",
  details:
    "Welcome to VELOUR, where culinary artistry meets exceptional dining experiences. We strive to create a gastronomic haven that tantalizes your taste buds and leaves you with unforgettable memories.",
};
